...
public sealed record MaterializedDayOfWeekTests
{
    ...
    public void MaterializeMonday()
    {
        Assert.Equal(
            ...
            new MaterializedDayOfWeek(new Monday()).Value
        );
    }
    ...
    public void MaterializeTuesday()
    {
        Assert.Equal(
            ...
            new MaterializedDayOfWeek(new Tuesday()).Value
        );
    }
    ...
    public void MaterializeWednesday()
    {
        Assert.Equal(
            ...
            new MaterializedDayOfWeek(new Wednesday()).Value
        );
    }
    ...
    public void MaterializeThursday()
    {
        Assert.Equal(
            ...
            new MaterializedDayOfWeek(new Thursday()).Value
        );
    }
    ...
    public void MaterializeFriday()
    {
        Assert.Equal(
            ...
            new MaterializedDayOfWeek(new Friday()).Value
        );
    }
    ...
    public void MaterializeSaturday()
    {
        Assert.Equal(
            ...
            new MaterializedDayOfWeek(new Saturday()).Value
        );
    }
    ...
    public void MaterializeSunday()
    {
        Assert.Equal(
            ...
            new MaterializedDayOfWeek(new Sunday()).Value
        );
    }
    ...
    public void ThrowExceptionOnGetHashCode()
    {
        _ = Assert.Throws<NotSupportedException>(() =>
            new MaterializedDayOfWeek(new Monday()).GetHashCode()
        );
    }
    ...
    {
        _ = Assert.Throws<NotSupportedException>(() =>
            new MaterializedDayOfWeek(new Monday()).ToString()
        );
    }
}
